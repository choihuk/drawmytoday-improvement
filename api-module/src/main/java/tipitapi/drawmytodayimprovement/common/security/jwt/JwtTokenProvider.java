...
import tipitapi.drawmytodayimprovement.common.security.jwt.exception.ExpiredRefreshTokenException;
...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        if (claims.get(CLAIM_USER_ROLE) == null || !StringUtils.hasText(
            ...
            throw new BusinessException(SecurityErrorCode.AUTHORITY_NOT_FOUND); //유저권한없음
        }
